/*
modded from 
github.com/nathan-pham/markdown-renderer

only real change was converting "code" blocks into "z-code" blocks 
to support syntax highlighting with web components
